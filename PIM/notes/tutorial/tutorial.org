...
The Menu Bar in Emacs is a horizontal bar at the top of the Emacs window that provides easy access to various features via dropdown menus (see [[id:eb4dc11f-3725-40ec-a511-f72bec1843c2][What you see when you open Emacs]] for more information). It is similar to Menu Bars in other applications, offering clickable items organized into categories such as "File", "Edit", "Options", "Buffers", and "Help".
...
You call command by several ways (see [[id:657dd016-284e-40ad-8591-4b3cac5f3cc7][Accessing Command]] to view all the method directly). The first method is to use the Menu Bar as describe in the first section of this introduction, the second introduced in this tutorial are the shortcuts.
